					...
					<c:forEach var="ms" items="${mss.content}">
						<tr>
							...
							<td class="text-center">
								<a href="/admin/adminMs/update/${ms.id}<custom:allParams/>" class="btn btn-outline-warning btn-sm">Update</a>
								<a href="/admin/adminMs/delete/${ms.id}<custom:allParams/>" class="btn btn-outline-danger btn-sm">Delete</a>
							</td>
						</tr>
					</c:forEach>
				</table>
