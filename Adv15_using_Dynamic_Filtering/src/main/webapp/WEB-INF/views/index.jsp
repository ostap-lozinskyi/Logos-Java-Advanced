                                ...
                                <div class="row row_home">
                                    ...
                                    <div class="col-xs-4 header_column">
                                        ...
                                        <sec:authorize access="isAnonymous()">
                                            <div class="login"> <a class="transparent_btn entry" href="/login" data-vivaldi-spatnav-clickable="1">Login</a> </div>
                                            <div class="login"> <a class="transparent_btn entry" href="/registration" data-vivaldi-spatnav-clickable="1">Register</a> </div>
                                        </sec:authorize>
                                        <sec:authorize access="hasRole('ROLE_ADMIN')">
                                            <div class="login"> <a class="transparent_btn entry" href="/admin" data-vivaldi-spatnav-clickable="1">Admin</a> </div>
                                        </sec:authorize>
